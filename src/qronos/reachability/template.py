...
if not os.path.isfile("template_system.xml.j2"):
    print("cannot find template XML. This script should be run as 'python3 -m qronos.reachability.template'")
    sys.exit(1)
...
requested_system_names = set(systems.keys()).intersection(set(sys.argv))
...
# Files are denoted with a unique prefix (e.g. A1) to simplify referencing them in publications
systems={}
systems['solved_with_spaceex/stable/A1_1']=examples.examples.example_A1_stable_1()
if not "--fast" in sys.argv:
    systems['solved_with_spaceex/stable/A2_1']=examples.examples.example_A2_stable_1()
    systems['solved_with_spaceex/stable/A3_1']=examples.examples.example_A3_stable_1()
    systems['unsolved/unknown/A4_1']=examples.examples.example_A4_unknown_1()
    systems['unsolved/stable/A5_diagonal_2']=examples.examples.example_A5_stable_diagonal(2)
    systems['solved_with_spaceex/stable/B1_stable_3']=examples.examples.example_B1_stable_3()
    systems['unsolved/stable/C1_quadrotor_one_axis_no_jitter_1']=examples.examples.example_C_quadrotor_attitude_one_axis(perfect_timing=True)
    systems['unsolved/unknown/C2_quadrotor_one_axis_with_jitter_1']=examples.examples.example_C_quadrotor_attitude_one_axis(perfect_timing=False)
    systems['unsolved/stable/D1_quadrotor_attitude_three_axis_no_jitter_3']=examples.examples.example_D_quadrotor_attitude_three_axis(perfect_timing=True)
    systems['unsolved/unknown/D2_quadrotor_attitude_three_axis_with_jitter_3']=examples.examples.example_D_quadrotor_attitude_three_axis(perfect_timing=False)
    systems['unsolved/unstable/E_timer']=examples.examples.example_E_timer()
    assert systems['unsolved/unstable/E_timer'].nominal_case_stability() == 'borderline unstable'
